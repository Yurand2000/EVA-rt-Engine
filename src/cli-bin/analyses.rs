...
pub fn uniprocessor_edf(
    ...
    use eva_rt_engine::algorithms::up_earliest_deadline_first::*;
...
pub fn uniprocessor_fp(
    ...
    use eva_rt_engine::algorithms::up_fixed_priority::*;
...
pub fn global_earliest_deadline_first(
    ...
    use eva_rt_engine::algorithms::smp_earliest_deadline_first::*;
...
pub fn global_fixed_priority(
    ...
    use eva_rt_engine::algorithms::smp_fixed_priority::*;
...
fn print_test_result(
    test_name: &str,
    res: Result<bool, eva_rt_engine::algorithms::Error>,
    quiet: bool,
) -> Result<bool, Box<dyn std::error::Error>> {
    match res {
        Ok(success) => {
        ...
        Err(err @ eva_rt_engine::algorithms::Error::Generic(_)) => Err(err.into()),
        Err(err) => {
            if !quiet {
